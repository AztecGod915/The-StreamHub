...
function SportCategoryGrid({ onSearch, favoriteTeams }) {
  return (
    <div style={{marginBottom:20}}>
      {/* NFL Preseason 2026 Banner */}
      <div onClick={()=>onSearch("NFL football")}
        style={{
          background:"linear-gradient(160deg,#001a00 0%,#003300 45%,#001200 100%)",
          border:"2px solid rgba(255,255,255,.35)",
          borderRadius:16, marginBottom:12,
          cursor:"pointer", position:"relative", overflow:"hidden",
          boxShadow:"0 8px 32px rgba(255,255,255,.08), 0 0 60px rgba(16,185,129,.06)",
          transition:"all .2s", minHeight:160,
        }}
        onMouseEnter={e=>{e.currentTarget.style.borderColor="rgba(255,255,255,.7)";e.currentTarget.style.transform="scale(1.005)";}}
        ...
        {(()=>{
          const TEAMS = [
            ...
            {code:"DAL",color:"#003594"},{code:"BUF",color:"#00338D"},
            {code:"PHI",color:"#004C54"},{code:"BAL",color:"#241773"},
            {code:"DET",color:"#0076B6"},{code:"MIA",color:"#008E97"},
            {code:"CIN",color:"#FB4F14"},{code:"LAR",color:"#003594"},
            {code:"GB",color:"#203731"}, {code:"MIN",color:"#4F2683"},
            {code:"HOU",color:"#03202F"},{code:"CLE",color:"#FF3C00"},
            {code:"SEA",color:"#002244"},{code:"ATL",color:"#A71930"},
            {code:"NO",color:"#D3BC8D"}, {code:"NYG",color:"#0B2265"},
            {code:"PIT",color:"#FFB612"},{code:"LV",color:"#000000"},
            {code:"NE",color:"#002244"}, {code:"JAX",color:"#006778"},
            {code:"TB",color:"#D50A0A"}, {code:"ARI",color:"#97233F"},
            {code:"LAC",color:"#0080C6"},{code:"DEN",color:"#FB4F14"},
            {code:"TEN",color:"#0C2340"},{code:"IND",color:"#002C5F"},
            {code:"CHI",color:"#0B162A"},{code:"NYJ",color:"#125740"},
            {code:"CAR",color:"#0085CA"},{code:"WAS",color:"#773141"},
          ];
          const Strip = ({sfx}) => TEAMS.map((t,i)=>(
            <span key={sfx+i} style={{
              ...
              background:t.color,
              color:t.color==="#D3BC8D"?"#000":"#fff",
              fontSize:7.5,fontWeight:900,letterSpacing:.3,
        ...
        <div style={{position:"relative",zIndex:1,padding:"18px 20px 34px",display:"flex",flexDirection:"column",alignItems:"center",gap:10,textAlign:"center"}}>
          ...
          <div style={{
            ...
            color:"#fff",
            textShadow:"0 0 30px rgba(255,255,255,.4), 0 0 60px rgba(255,255,255,.15), 0 2px 4px rgba(0,0,0,.9)",
          }}>🏈 NFL Preseason 2026</div>

          {/* Pills */}
          <div style={{display:"flex",justifyContent:"center",alignItems:"center",gap:8,flexWrap:"wrap"}}>
            <div style={{background:"#fff",borderRadius:99,padding:"3px 12px",fontSize:9,fontWeight:900,color:"#003300",letterSpacing:.8,boxShadow:"0 0 12px rgba(255,255,255,.5)"}}>⚡ PRESEASON STARTS AUG 7</div>
            <div style={{background:"rgba(255,255,255,.12)",borderRadius:99,padding:"3px 10px",fontSize:9,fontWeight:900,color:"#fff",letterSpacing:.8,border:"1px solid rgba(255,255,255,.3)"}}>32 TEAMS</div>
            <div style={{background:"rgba(255,255,255,.08)",borderRadius:99,padding:"3px 10px",fontSize:9,fontWeight:900,color:"rgba(255,255,255,.8)",letterSpacing:.8,border:"1px solid rgba(255,255,255,.2)"}}>REGULAR SEASON SEP 4</div>
          </div>

          {/* Matchup highlights */}
          <div style={{display:"flex",justifyContent:"center",gap:8,flexWrap:"wrap"}}>
            {[
              {label:"Chiefs",    badge:"KC",  bg:"#E31837", glow:"rgba(227,24,55,.6)"},
              {label:"49ers",     badge:"SF",  bg:"#AA0000", glow:"rgba(170,0,0,.6)"},
              {label:"Cowboys",   badge:"DAL", bg:"#003594", glow:"rgba(0,53,148,.6)"},
              {label:"Bills",     badge:"BUF", bg:"#00338D", glow:"rgba(0,51,141,.6)"},
            ].map((h,i)=>(
              <div key={i} style={{
