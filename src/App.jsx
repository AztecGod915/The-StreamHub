...
function PredictionStatsBar({ compact=false }) {
  ...
  return (
    <div style={{
      ...
      display:"flex", flexDirection:"column", gap:0, minHeight:compact?0:120,
    }}>
      {/* Title row */}
        ...
        <div style={{display:"flex",flexDirection:"column",gap:3,flex:1}}>
          {[
            ...
            <div key={st.label} style={{
              ...
              <div style={{fontSize:8,color:st.color,fontWeight:700,opacity:.75}}>{st.label}</div>
              <div style={{fontFamily:"var(--font-head)",fontWeight:900,fontSize:12,color:st.color,lineHeight:1}}>{st.val}</div>
            </div>
          ))}
        </div>
      ) : (
