...
function FavoriteTeamsBanner({ favoriteTeams, compact=false }) {
  ...
  const GameCard = ({r, l}) => {
    ...
    if (!r) return null;
    return (
      <div style={{background:"linear-gradient(135deg,#1e3a5f,#0f2744)",border:"1.5px solid rgba(96,165,250,.4)",borderRadius:12,padding:"10px 10px",marginTop:8}}>
        {/* Sport label + status */}
        ...
        {[r.away,r.home].map((t,i)=>(
          <div key={i} style={{display:"flex",alignItems:"center",gap:8,marginBottom:i===0?6:0}}>
            ...
            <div style={{width:32,height:32,borderRadius:"50%",background:"#fff",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,boxShadow:"0 2px 8px rgba(0,0,0,.4)"}}>
              {t.logo
            ...
            <span style={{fontSize:13,fontWeight:700,flex:1,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",color:"#f1f5f9"}}>{t.name}</span>
  ...
  return (
    <div style={{
      ...
      {/* Search bar */}
      <div style={{marginTop:compact?7:9,paddingTop:compact?5:7,borderTop:"1px solid rgba(59,130,246,.1)"}}>
  ...
  return (
    <div style={{marginBottom:20}}>
      ...
      <div onClick={()=>onSearch("MLB baseball")}
        style={{
          background:"linear-gradient(160deg,#0a0505 0%,#1a0a0a 40%,#100308 100%)",
        ...
        onMouseLeave={e=>{e.currentTarget.style.borderColor="rgba(200,16,46,.55)";e.currentTarget.style.transform="scale(1)";}}>

        {/* Animated baseballs */}
        {[
          {s:36, t:"6%",   l:"44%", d:"8s",  dl:"0s",   o:.38},
          {s:24, t:"58%",  l:"58%", d:"10s", dl:"1.4s", o:.3},
          {s:42, t:"4%",   l:"70%", d:"12s", dl:"2.8s", o:.25},
          {s:18, t:"65%",  l:"78%", d:"9s",  dl:"0.8s", o:.35},
          {s:30, t:"18%",  l:"84%", d:"11s", dl:"3.2s", o:.28},
          {s:16, t:"72%",  l:"90%", d:"13s", dl:"1.6s", o:.25},
          {s:48, t:"-8%",  l:"62%", d:"15s", dl:"0.4s", o:.16},
        ...
        {(()=>{
          ...
          const Strip = ({sfx}) => TEAMS.map((t,i)=>(
            <span key={sfx+i} style={{
              ...
              width:30,height:17,borderRadius:3,
              background:t.color,
          ...
          return (
            <div style={{position:"absolute",bottom:0,left:0,right:0,height:26,overflow:"hidden",pointerEvents:"none",background:"rgba(0,0,0,.3)"}}>
              <div style={{display:"inline-flex",alignItems:"center",padding:"4px 0",whiteSpace:"nowrap",animation:"wcFlags 26s linear infinite"}}>
        ...
        <div style={{position:"relative",zIndex:1,padding:"18px 20px 34px",display:"flex",flexDirection:"column",alignItems:"center",gap:10,textAlign:"center"}}>
          ...
          <div style={{
            ...
            color:"#fff",
            textShadow:"0 0 30px rgba(200,16,46,.8), 0 0 60px rgba(200,16,46,.4), 0 2px 4px rgba(0,0,0,.9)",
          }}>⚾ MLB All-Star 2026</div>

          {/* Pills */}
          <div style={{display:"flex",justifyContent:"center",alignItems:"center",gap:8}}>
            <div style={{background:"#C8102E",borderRadius:99,padding:"3px 10px",fontSize:9,fontWeight:900,color:"#fff",letterSpacing:.8,boxShadow:"0 0 10px rgba(200,16,46,.7)"}}>⭐ ALL-STAR GAME</div>
            <div style={{background:"rgba(255,255,255,.1)",borderRadius:99,padding:"3px 10px",fontSize:9,fontWeight:900,color:"#fff",letterSpacing:.8,border:"1px solid rgba(255,255,255,.25)"}}>📍 PHILADELPHIA</div>
            <div style={{background:"rgba(200,16,46,.2)",borderRadius:99,padding:"3px 10px",fontSize:9,fontWeight:900,color:"#ff6b8a",letterSpacing:.8,border:"1px solid rgba(200,16,46,.4)"}}>JULY 14</div>
          </div>

          {/* Event highlights */}
          <div style={{display:"flex",justifyContent:"center",gap:10}}>
            {[
              {label:"Home Run Derby", date:"Jul 13", glow:"rgba(200,16,46,.6)", bg:"linear-gradient(135deg,#C8102E,#8B0000)"},
              {label:"All-Star Game",  date:"Jul 14", glow:"rgba(0,48,135,.6)",  bg:"linear-gradient(135deg,#003087,#001A5C)"},
              {label:"Live on ESPN",   date:"",       glow:"rgba(255,107,0,.5)", bg:"linear-gradient(135deg,#FF6600,#CC4400)"},
            ].map((h,i)=>(
              <div key={i} style={{
                ...
                <span style={{
                  display:"inline-flex",alignItems:"center",justifyContent:"center",
                  height:16,borderRadius:3,padding:"0 5px",
                  background:h.bg,
                  color:"#fff",fontSize:8,fontWeight:900,letterSpacing:.3,flexShrink:0,
                  boxShadow:`0 0 8px ${h.glow}`,
                }}>{h.date||"ESPN"}</span>
                <span style={{fontSize:10,fontWeight:800,color:"#fff",letterSpacing:.3}}>{h.label}</span>
              </div>
            ))}
          </div>
      ...
      {/* World Cup Hero Card — runs until July 19 */}
      <div onClick={()=>onSearch("FIFA World Cup 2026")}
        ...
        {(()=>{
          const CODES = [
            ...
            {code:"BE",color:"#000"},{code:"HR",color:"#CC1414"},{code:"NL",color:"#AE1C28"},
          ];
          const Strip = ({sfx}) => CODES.map((ct,i)=>(
            <span key={sfx+i} style={{
              display:"inline-flex",alignItems:"center",justifyContent:"center",
              width:26,height:17,borderRadius:3,background:ct.color,
              color:"#fff",fontSize:7.5,fontWeight:900,letterSpacing:.3,
              marginRight:5,flexShrink:0,
            }}>{ct.code}</span>
          ));
        ...
        <div style={{position:"relative",zIndex:1,padding:"18px 20px 34px",display:"flex",flexDirection:"column",alignItems:"center",gap:10,textAlign:"center"}}>
          <div style={{
            fontFamily:"'Bebas Neue', var(--font-head)",
            fontWeight:400, fontSize:"clamp(28px,5vw,48px)",
            letterSpacing:3, lineHeight:1, color:"#F59E0B",
          ...
          <div style={{display:"flex",justifyContent:"center",alignItems:"center",gap:8}}>
            ...
            <div style={{background:"rgba(255,255,255,.08)",borderRadius:99,padding:"3px 10px",fontSize:9,fontWeight:900,color:"rgba(255,255,255,.8)",letterSpacing:.8,border:"1px solid rgba(255,255,255,.2)"}}>FINAL JUL 19</div>
          </div>
          <div style={{display:"flex",justifyContent:"center",gap:10}}>
            {[
              ...
              <div key={i} style={{
                ...
                padding:"5px 14px 5px 7px",border:"1px solid rgba(255,255,255,.2)",
                boxShadow:`0 0 14px ${h.glow}`,
              }}>
                <span style={{
                  display:"inline-flex",alignItems:"center",justifyContent:"center",
                  width:26,height:16,borderRadius:3,background:h.bg,
                  color:"#fff",fontSize:8,fontWeight:900,letterSpacing:.4,flexShrink:0,
                  textShadow:"0 0 6px rgba(255,255,255,.8)",boxShadow:`0 0 8px ${h.glow}`,
                }}>{h.iso}</span>
                <span style={{
                  fontSize:11,fontWeight:800,color:"#fff",
                  textShadow:`0 0 10px ${h.glow}`,letterSpacing:.5,
                }}>{h.name}</span>
              </div>
            ))}
          </div>
          ...
          <div style={{padding:"12px 14px",overflowY:"auto",flex:1}}>
            {!safeSearch.trim() ? (
              <>
                ...
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,marginBottom:8,alignItems:"start",minWidth:0,overflow:"hidden"}}>
