  ...
  return (
    <div style={{marginBottom:20}}>
      ...
      <div onClick={()=>onSearch("NFL football")}
        ...
        {/* Goalpost SVG — left side */}
        <div style={{position:"absolute",left:8,top:0,bottom:0,width:110,pointerEvents:"none",opacity:.25,display:"flex",alignItems:"center",justifyContent:"center"}}>
          <svg viewBox="0 0 80 150" width="80" height="150">
            <g stroke="#FFD700" strokeWidth="6" strokeLinecap="round" fill="none">
              <line x1="40" y1="150" x2="40" y2="80"/>
              <line x1="5"  y1="80"  x2="75" y2="80"/>
              <line x1="5"  y1="80"  x2="5"  y2="5"/>
              <line x1="75" y1="80"  x2="75" y2="5"/>
            </g>
          </svg>
        </div>

        {/* Animated footballs — right side */}
        {[
          {s:36, t:"6%",   l:"55%", d:"8s",  dl:"0s",   o:.38},
          {s:24, t:"58%",  l:"65%", d:"10s", dl:"1.4s", o:.3},
          {s:42, t:"4%",   l:"72%", d:"12s", dl:"2.8s", o:.25},
          {s:18, t:"65%",  l:"80%", d:"9s",  dl:"0.8s", o:.35},
          {s:30, t:"18%",  l:"85%", d:"11s", dl:"3.2s", o:.28},
        ...
        {(()=>{
          const TEAMS = [
            ...
            {code:"PIT",color:"#FFB612"},{code:"LV",color:"#222"},
          ...
          const Strip = ({sfx}) => TEAMS.map((t,i)=>(
            <span key={sfx+i} style={{
              ...
              width:30,height:17,borderRadius:3,background:t.color,
        ...
        <div style={{position:"relative",zIndex:1,padding:"18px 20px 34px",display:"flex",flexDirection:"column",alignItems:"center",gap:10,textAlign:"center"}}>
          ...
          <div style={{display:"flex",justifyContent:"center",alignItems:"center",gap:8,flexWrap:"wrap"}}>
            <div style={{background:"#fff",borderRadius:99,padding:"3px 12px",fontSize:9,fontWeight:900,color:"#003300",letterSpacing:.8,boxShadow:"0 0 12px rgba(255,255,255,.5)"}}>⚡ PRESEASON AUG 7</div>
          ...
          <div style={{display:"flex",justifyContent:"center",gap:8,flexWrap:"wrap"}}>
            {[
              {icon:"📺", text:"ESPN · Fox · NBC · Amazon Prime"},
              {icon:"🏆", text:"Super Bowl LXI — Feb 1, 2027"},
              {icon:"🎟️", text:"272 games across 18 weeks"},
            ].map((h,i)=>(
              <div key={i} style={{
