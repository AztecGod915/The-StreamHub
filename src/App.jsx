...
export default function StreamHub() {
  ...
  if (isMobile) return (
    <>
      ...
      <div style={{textAlign:"center",padding:"16px 14px 90px",borderTop:"1px solid var(--border)",marginTop:16}}>
  ...
  if (device === "tablet") return (
    <>
      ...
      <div style={{minHeight:"100vh",background:"var(--bg)",paddingBottom:72}}>
        ...
        {/* Footer — tablet */}
        <div style={{textAlign:"center",padding:"16px 20px 120px",borderTop:"1px solid var(--border)",marginTop:8}}>
          <div style={{fontSize:11,color:"var(--muted)",display:"flex",gap:14,justifyContent:"center",flexWrap:"wrap"}}>
            <button onClick={()=>setShowPrivacy(true)} style={{background:"none",border:"none",color:"var(--muted)",cursor:"pointer",fontSize:11,fontFamily:"inherit",textDecoration:"underline"}}>Privacy Policy</button>
            <span style={{opacity:.3}}>·</span>
            <button onClick={()=>setShowTerms(true)} style={{background:"none",border:"none",color:"var(--muted)",cursor:"pointer",fontSize:11,fontFamily:"inherit",textDecoration:"underline"}}>Terms of Service</button>
            <span style={{opacity:.3}}>·</span>
              ...
              <div style={{display:"flex",alignItems:"center",gap:14}}>
                ...
                <div>
                  ...
                  <div style={{display:"flex",gap:12,marginTop:6}}>
                    ...
                    <button onClick={()=>setShowTerms(true)} style={{background:"none",border:"none",color:"var(--muted)",cursor:"pointer",fontSize:11,fontFamily:"inherit",textDecoration:"underline"}}>Terms of Service</button>
                    <span style={{color:"rgba(255,255,255,.2)",fontSize:11}}>·</span>
                    <span style={{fontSize:11,color:"rgba(255,255,255,.2)"}}>© 2026 The StreamHub</span>
                  </div>
                </div>
              </div>
