...
function PredictionStatsBar({ compact=false }) {
  ...
  if (s.total === 0) return (
    <div style={{
      ...
      <div>
        <div style={{fontFamily:"var(--font-head)",fontWeight:800,fontSize:compact?11:13,color:"#f1f5f9",marginBottom:2}}>Predictions</div>
      ...
      <button onClick={sharePredictions} style={{marginTop:"auto",background:"rgba(255,255,255,.1)",border:"1px solid rgba(255,255,255,.2)",borderRadius:8,color:"#e2e8f0",padding:"4px 0",fontSize:9,fontWeight:700,cursor:"pointer",width:"100%"}}>📤 Share</button>
    </div>
  );
  ...
  return (
    <div style={{
      ...
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:compact?6:10}}>
        <div style={{fontFamily:"var(--font-head)",fontWeight:800,fontSize:compact?11:13,color:"#f1f5f9",display:"flex",alignItems:"center",gap:5}}>
          🔮 Predictions {milestone&&<span style={{fontSize:compact?11:14}}>{milestone.icon}</span>}
        </div>
        <button onClick={sharePredictions} style={{background:"rgba(255,255,255,.1)",border:"1px solid rgba(255,255,255,.25)",borderRadius:7,color:"#e2e8f0",padding:"2px 6px",fontSize:9,fontWeight:700,cursor:"pointer"}}>📤</button>
      </div>
      {/* 2x2 stats grid */}
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:compact?4:6,marginBottom:compact?6:10}}>
        {[
          ...
          <div key={st.label} style={{background:"rgba(255,255,255,.07)",borderRadius:compact?7:9,padding:compact?"4px 3px":"6px 4px",textAlign:"center"}}>
  ...
  const GameCard = ({r, l}) => {
    ...
    return (
      <div style={{background:"rgba(0,0,0,.25)",borderRadius:8,padding:"6px 8px",marginTop:6,display:"flex",alignItems:"center",gap:8}}>
        <div style={{flex:1,minWidth:0}}>
          <div style={{fontSize:8,color:"rgba(96,165,250,.5)",fontWeight:700,letterSpacing:.8,marginBottom:3}}>{r.sport.toUpperCase()}</div>
        ...
        <div style={{flexShrink:0,textAlign:"center",minWidth:52}}>
          {r.isLive
            ...
            : r.isOver
              ...
              : <div style={{background:"rgba(59,130,246,.1)",border:"1px solid rgba(59,130,246,.2)",borderRadius:5,padding:"2px 5px"}}>
  ...
  return (
    <div style={{
      ...
      {allFavTeams.length===0
        ? <div style={{fontSize:9,color:"rgba(96,165,250,.6)",marginBottom:6}}>Tap ⭐ on a sport to follow</div>
