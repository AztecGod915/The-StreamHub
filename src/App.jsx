  ...
  return (
    <div onMouseEnter={()=>setPaused(true)} onMouseLeave={()=>setPaused(false)}
      style={{
        ...
        boxShadow:"0 0 24px rgba(239,68,68,.25),0 0 48px rgba(239,68,68,.1)",
      }}>
      ...
      <div style={{display:"flex",alignItems:"center",height:35,borderBottom:"1px solid rgba(239,68,68,.12)"}}>
        <div style={{
          ...
          color:"#fff",fontSize:11,fontWeight:900,letterSpacing:.8,
          height:"100%",display:"flex",alignItems:"center",justifyContent:"center",
          textAlign:"center",lineHeight:1.4,textTransform:"uppercase",
          boxShadow:"4px 0 20px rgba(239,68,68,.6)",
          flexDirection:"column",gap:4,cursor:"pointer",
          paddingTop:4,
        }} onClick={()=>setPaused(p=>!p)}>
          <span style={{display:"block"}}>⚡ SPORTS</span>
          <span style={{display:"block"}}>BUZZ</span>
          <span style={{fontSize:12,lineHeight:1,marginTop:2}}>{paused ? "▶" : "⏸"}</span>
        </div>
