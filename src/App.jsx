    ...
    <div style={{
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:compact?4:6,marginBottom:compact?6:10}}>
        {[
          ...
          <div key={st.label} style={{background:"rgba(0,0,0,.06)",borderRadius:compact?7:9,padding:compact?"4px 3px":"6px 4px",textAlign:"center"}}>
            <div style={{fontFamily:"var(--font-head)",fontWeight:900,fontSize:compact?12:14,color:st.color,lineHeight:1}}>{st.val}</div>
            <div style={{fontSize:7,color:"rgba(0,0,0,.5)",fontWeight:700,letterSpacing:.4,marginTop:2}}>{st.label}</div>
          </div>
        ))}
      </div>
      {/* Progress bar */}
      {nextMilestone ? (
        <div style={{marginTop:"auto"}}>
          ...
          <div style={{height:3,background:"rgba(0,0,0,.1)",borderRadius:99,overflow:"hidden"}}>
...
function FavoriteTeamsBanner({ favoriteTeams, compact=false }) {
  ...
  const GameCard = ({r, l}) => {
    ...
    if (!r) return null;
    return (
      <div style={{background:"rgba(0,0,0,.25)",borderRadius:10,padding:"8px 10px",marginTop:8,display:"flex",alignItems:"center",gap:8}}>
        <div style={{flex:1,minWidth:0}}>
          <div style={{fontSize:10,color:"rgba(96,165,250,.65)",fontWeight:700,letterSpacing:.8,marginBottom:4}}>{r.sport.toUpperCase()}</div>
          {[r.away,r.home].map((t,i)=>(
            <div key={i} style={{display:"flex",alignItems:"center",gap:4,marginBottom:i===0?2:0}}>
              ...
              {(r.isLive||r.isOver)&&<span style={{fontFamily:"var(--font-head)",fontWeight:900,fontSize:13,color:t.winner?"var(--gold)":"var(--text)",flexShrink:0}}>{t.score}</span>}
            </div>
          ))}
        </div>
  ...
  return (
    <div style={{
      ...
      {/* Title */}
      <div style={{fontFamily:"var(--font-head)",fontWeight:800,fontSize:compact?11:13,color:"var(--gold)",marginBottom:6}}>🛡️ My Teams</div>
