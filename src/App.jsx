  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
      ...
      @keyframes wcFloat { 0%,100%{transform:translateY(0) rotate(0deg)} 33%{transform:translateY(-8px) rotate(120deg)} 66%{transform:translateY(4px) rotate(240deg)} }
  ...
  return (
    <div style={{marginBottom:20}}>
      ...
      <div onClick={()=>onSearch("FIFA World Cup 2026")}
        ...
        {[
          {size:28,top:"8%", left:"72%",  dur:"7s",  delay:"0s",   op:.13},
          {size:18,top:"55%",left:"88%",  dur:"9s",  delay:"1.5s", op:.1},
          {size:22,top:"20%",left:"92%",  dur:"11s", delay:"3s",   op:.08},
          {size:14,top:"70%",left:"60%",  dur:"8s",  delay:"0.5s", op:.12},
          {size:32,top:"-5%",left:"55%",  dur:"13s", delay:"2s",   op:.07},
        ].map((b,i)=>(
          <div key={i} style={{
        ...
        {/* Animated flag strip — scrolling behind content */}
        <div style={{
          position:"absolute", bottom:0, left:0, right:0, height:28,
          overflow:"hidden", pointerEvents:"none", opacity:.18,
        }}>
          <div style={{
            display:"flex", gap:0, whiteSpace:"nowrap",
            animation:"wcFlags 18s linear infinite",
