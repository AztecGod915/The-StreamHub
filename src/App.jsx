...
function PredictionStatsBar({ compact=false }) {
  ...
  return (
    <div style={{
      ...
      {/* Title row — share button only shown here on full size */}
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:compact?5:10}}>
        ...
        {!compact && <button onClick={sharePredictions} style={{background:"rgba(0,0,0,.07)",border:"1px solid rgba(0,0,0,.15)",borderRadius:7,color:"#333",padding:"2px 6px",fontSize:9,fontWeight:700,cursor:"pointer"}}>📤</button>}
      </div>
