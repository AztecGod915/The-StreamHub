...
function SportsNewsTicker() {
            ...
            return (
              <div key={i} onClick={()=>h.url&&window.open(h.url,"_blank","noopener")}
                style={{
                  ...
                  opacity:paused?1:.85,transition:"opacity .2s",
                }}>
  ...
  return (
    <div onMouseEnter={()=>setPaused(true)} onMouseLeave={()=>setPaused(false)}
      ...
      <div style={{display:"flex",alignItems:"center",height:35,borderBottom:"1px solid rgba(239,68,68,.12)"}}>
        <div style={{
          ...
          boxShadow:"4px 0 16px rgba(239,68,68,.35)",
          flexDirection:"column",gap:2,cursor:"pointer",
          padding:"0 4px",
        }} onClick={()=>setPaused(p=>!p)}>
          <span style={{fontSize:9,fontWeight:900,letterSpacing:.8,lineHeight:1.3,display:"block",textShadow:"0 0 10px rgba(239,68,68,.8)"}}>⚡ SPORTS</span>
          <span style={{fontSize:9,fontWeight:900,letterSpacing:.8,lineHeight:1.3,display:"block",textShadow:"0 0 10px rgba(239,68,68,.8)"}}>BUZZ</span>
          <span style={{fontSize:11,lineHeight:1,marginTop:3,textShadow:"0 0 8px rgba(239,68,68,.9)"}}>{paused ? "▶" : "⏸"}</span>
        </div>
        <TickerRow items={row1} reverse={false}/>
      </div>
      {/* Row 2 — scrolls reverse, same label area for alignment */}
      <div style={{display:"flex",alignItems:"center",height:35}}>
        <div style={{
          flexShrink:0,width:80,
          background:"rgba(189,28,28,.25)",
          height:"100%",
          borderRight:"1px solid rgba(239,68,68,.2)",
        }}/>
