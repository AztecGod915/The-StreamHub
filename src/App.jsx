    ...
    <div style={{marginBottom:20}}>
      ...
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:12,flexWrap:"wrap",gap:8}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"}}>
          ...
          <button onClick={()=>doFetch(false, dateOffset)} style={{background:"rgba(16,185,129,.1)",border:"1px solid rgba(16,185,129,.3)",borderRadius:8,color:"var(--sports)",padding:"4px 10px",fontSize:11,fontWeight:700,cursor:"pointer"}}>↻</button>
        </div>
      </div>
...
function PredictionPoll({ evt, user, showToast, onResult }) {
  ...
  useEffect(() => {
    ...
    if (predCorrect) {
      ...
      onResult?.({correct:false, streak:old.streak, points:0});
    }
      ...
      {myPick && !evt.isOver && (
        <>
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:6}}>
            ...
            {stats.streak>=3&&<div style={{fontSize:9,color:"#F59E0B",fontWeight:700}}>🔥 {stats.streak} streak riding on this</div>}
          </div>
          {community ? (
            <>
              <div style={{display:"grid",gridTemplateColumns:"1fr 40px 1fr",gap:5}}>
