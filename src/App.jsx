          ...
          <div style={{
            ...
            <div onClick={()=>setShowMoodSearch(true)}
              style={{
                ...
                borderRadius:14,padding:"12px 14px",
                cursor:"pointer",position:"relative",overflow:"hidden",
                boxShadow:"0 0 24px rgba(251,146,60,.25), 0 4px 16px rgba(251,146,60,.15)",
                display:"flex",alignItems:"center",justifyContent:"space-between",gap:10,
                transition:"all .2s",
              }}
              onTouchStart={e=>e.currentTarget.style.borderColor="rgba(251,146,60,.9)"}
              onTouchEnd={e=>e.currentTarget.style.borderColor="rgba(251,146,60,.55)"}>
              {/* Glow orb */}
              <div style={{position:"absolute",top:-20,right:-20,width:100,height:100,borderRadius:"50%",background:"rgba(251,146,60,.2)",filter:"blur(30px)",pointerEvents:"none"}}/>
              <div style={{display:"flex",alignItems:"center",gap:10,position:"relative"}}>
                <div style={{width:36,height:36,borderRadius:10,background:"linear-gradient(135deg,#c2410c,#fb923c)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:20,flexShrink:0,boxShadow:"0 4px 14px rgba(251,146,60,.5)"}}>🎭</div>
                <div>
                  <div style={{fontFamily:"var(--font-head)",fontWeight:900,fontSize:14,background:"linear-gradient(90deg,#fdba74,#fff7ed)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>Mood Search</div>
                  <div style={{fontSize:10,color:"rgba(253,186,116,.7)"}}>Describe a vibe — AI finds the match</div>
                </div>
              </div>
              <div style={{display:"flex",flexDirection:"column",alignItems:"flex-end",gap:4,position:"relative",flexShrink:0}}>
                ...
                <span style={{background:"rgba(251,146,60,.2)",border:"1px solid rgba(251,146,60,.4)",borderRadius:6,padding:"2px 8px",fontSize:9,fontWeight:700,color:"#fb923c"}}>Free ✓</span>
              </div>
            </div>
            ...
            <div style={{textAlign:"center"}}>
              ...
              <div onClick={()=>setShowMoodSearch(true)}
                style={{
                  ...
                  cursor:"pointer",position:"relative",overflow:"hidden",
                  boxShadow:"0 0 28px rgba(251,146,60,.25), 0 4px 16px rgba(251,146,60,.15)",
                  display:"flex",alignItems:"center",justifyContent:"space-between",gap:12,
                  transition:"all .2s",pointerEvents:"all",
                }}
                onMouseEnter={e=>{e.currentTarget.style.borderColor="rgba(251,146,60,.9)";e.currentTarget.style.boxShadow="0 0 36px rgba(251,146,60,.4)";}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor="rgba(251,146,60,.55)";e.currentTarget.style.boxShadow="0 0 28px rgba(139,92,246,.25)";}}>
                <div style={{position:"absolute",top:-20,right:-20,width:120,height:120,borderRadius:"50%",background:"rgba(251,146,60,.18)",filter:"blur(35px)",pointerEvents:"none"}}/>
                <div style={{display:"flex",alignItems:"center",gap:12,position:"relative"}}>
                  <div style={{width:40,height:40,borderRadius:12,background:"linear-gradient(135deg,#c2410c,#fb923c)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:22,flexShrink:0,boxShadow:"0 4px 16px rgba(251,146,60,.55)"}}>🎭</div>
                  <div>
                    <div style={{fontFamily:"var(--font-head)",fontWeight:900,fontSize:16,background:"linear-gradient(90deg,#fdba74,#fff7ed)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>Mood Search</div>
                    <div style={{fontSize:11,color:"rgba(253,186,116,.7)"}}>Describe a vibe — AI finds the perfect match</div>
                  </div>
                </div>
                <div style={{display:"flex",flexDirection:"column",alignItems:"flex-end",gap:4,position:"relative",flexShrink:0}}>
                  <span style={{background:"var(--gold)",color:"#000",fontSize:9,fontWeight:900,padding:"2px 8px",borderRadius:99}}>AI</span>
                  <span style={{background:"rgba(251,146,60,.2)",border:"1px solid rgba(251,146,60,.4)",borderRadius:6,padding:"2px 10px",fontSize:10,fontWeight:700,color:"#fb923c"}}>Free for all ✓</span>
                </div>
              </div>
                ...
                <div style={{position:"relative",display:"flex",alignItems:"flex-start",gap:16}}>
                  ...
                  <div style={{flex:1}}>
                    <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:6}}>
                      <div style={{fontFamily:"var(--font-head)",fontWeight:900,fontSize:20,background:"linear-gradient(90deg,#fdba74,#fff7ed)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>Mood Search</div>
