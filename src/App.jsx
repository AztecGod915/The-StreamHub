  ...
  return (
    <div style={{
      ...
      {activeTeam && (
        ...
        style={{
          width:"100%", marginTop:compact?6:10,
          background:"rgba(59,130,246,.1)", border:"1.5px solid rgba(59,130,246,.3)",
          borderRadius:compact?8:10, color:"#60a5fa", padding:compact?"6px 0":"8px 0",
          fontSize:compact?11:12, fontWeight:800, cursor:"pointer",
          display:"flex", alignItems:"center", justifyContent:"center", gap:5,
        }}>📤 Share with a friend</button>
      )}
