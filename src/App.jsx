...
function PredictionStatsBar({ compact=false }) {
  ...
  if (s.total === 0) return (
    <div style={{
      ...
      cursor:"default", minHeight:compact?72:120,
    }}>
  ...
  return (
    <div style={{
      ...
      border:"1.5px solid rgba(0,0,0,.1)",
      borderRadius:16, padding:compact?"10px 10px":"14px 14px",
      display:"flex", flexDirection:"column", gap:0, minHeight:compact?72:120,
    }}>
      {/* Title row */}
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:compact?4:10}}>
        <div style={{fontFamily:"var(--font-head)",fontWeight:900,fontSize:compact?11:13,color:"#111",display:"flex",alignItems:"center",gap:5}}>
          <span style={{fontSize:compact?16:28,marginRight:4}}>🔮</span>Predictions {milestone&&<span style={{fontSize:compact?11:14}}>{milestone.icon}</span>}
        </div>
      ...
      {/* 2x2 stats grid */}
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:compact?3:6,marginBottom:compact?4:10}}>
        {[
          ...
          <div key={st.label} style={{background:st.bg,border:`2px solid ${st.border}`,borderRadius:compact?7:9,padding:compact?"3px 2px":"8px 6px",textAlign:"center"}}>
            <div style={{fontFamily:"var(--font-head)",fontWeight:900,fontSize:compact?11:16,color:st.color,lineHeight:1}}>{st.val}</div>
            <div style={{fontSize:compact?7:8,color:st.color,opacity:.7,fontWeight:700,letterSpacing:.4,marginTop:2}}>{st.label}</div>
          </div>
        ))}
      </div>
