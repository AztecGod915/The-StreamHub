  ...
  if (isMobile) return (
    <>
      ...
      <div style={{minHeight:"100vh",background:"var(--bg)",paddingBottom:80}}>
        ...
        {/* Footer */}
        <div style={{textAlign:"center",padding:"16px 24px 8px",borderTop:"1px solid var(--border)",marginTop:8}}>
          <div style={{fontSize:11,color:"var(--muted)",display:"flex",gap:16,justifyContent:"center",flexWrap:"wrap"}}>
            <a href="/privacy.html" style={{color:"var(--muted)",textDecoration:"none"}} onMouseEnter={e=>e.target.style.color="#fff"} onMouseLeave={e=>e.target.style.color="var(--muted)"}>Privacy Policy</a>
            <span style={{opacity:.3}}>·</span>
            <a href="/terms.html" style={{color:"var(--muted)",textDecoration:"none"}} onMouseEnter={e=>e.target.style.color="#fff"} onMouseLeave={e=>e.target.style.color="var(--muted)"}>Terms of Service</a>
            <span style={{opacity:.3}}>·</span>
