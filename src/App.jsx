...
function SportsNewsTicker() {
  ...
  const handlePauseToggle = () => {
    const next = !paused;
    setPaused(next);
    const state = next ? "paused" : "running";
  ...
  return (
    <div
      ...
      <div
        ...
        <span style={{fontSize:18,lineHeight:1,marginTop:2,textShadow:"0 0 10px rgba(239,68,68,1)"}}>{paused?"▶":"⏸"}</span>
      </div>
...
<MobileBottomNav view={view} setView={v=>{handleSetView(v);setSearch("");}} watchlist={watchlist} tier={tier} onProfile={()=>user?setShowProfile(true):setShowAuth(true)} />
      ...
      <div style={{textAlign:"center",padding:"20px 14px 100px",borderTop:"1px solid var(--border)",marginTop:8}}>
