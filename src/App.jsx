  ...
  return (
    <div style={{marginBottom:20}}>
      ...
      <div onClick={()=>onSearch("FIFA World Cup 2026")}
        ...
        <div style={{position:"relative",zIndex:1,padding:"18px 20px 34px",display:"flex",flexDirection:"column",gap:10}}>

          {/* Host nations — centred at top */}
          <div style={{display:"flex",justifyContent:"center",gap:10}}>
            {[
              {iso:"US",name:"USA",    bg:"linear-gradient(135deg,#3C3B6E,#BF0A30)"},
              {iso:"MX",name:"Mexico", bg:"linear-gradient(135deg,#006847,#CE1126)"},
              {iso:"CA",name:"Canada", bg:"linear-gradient(135deg,#CC0000,#cc000088)"},
            ].map((h,i)=>(
              <div key={i} style={{display:"flex",alignItems:"center",gap:5,background:"rgba(255,255,255,.1)",borderRadius:99,padding:"4px 12px 4px 6px",border:"1px solid rgba(255,255,255,.15)"}}>
                <span style={{display:"inline-flex",alignItems:"center",justifyContent:"center",width:24,height:15,borderRadius:3,background:h.bg,color:"#fff",fontSize:8,fontWeight:900,letterSpacing:.3,flexShrink:0}}>{h.iso}</span>
                <span style={{fontSize:11,fontWeight:700,color:"rgba(255,255,255,.9)"}}>{h.name}</span>
              </div>
            ))}
          </div>
          ...
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8,flexWrap:"wrap"}}>
            <div>
              <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:6}}>
                <div style={{background:"#ef4444",borderRadius:99,padding:"2px 8px",fontSize:9,fontWeight:900,color:"#fff",letterSpacing:.8,animation:"pulse 1.5s infinite"}}>🔴 LIVE NOW</div>
              ...
              <div style={{fontFamily:"var(--font-head)",fontWeight:900,fontSize:22,color:"var(--gold)",lineHeight:1.1,textShadow:"0 0 24px rgba(245,158,11,.45)"}}>🏆 FIFA World Cup 2026</div>
            </div>
            <div style={{background:"rgba(245,158,11,.12)",border:"1px solid rgba(245,158,11,.35)",borderRadius:10,padding:"10px 16px",textAlign:"center",boxShadow:"0 0 16px rgba(245,158,11,.15)",flexShrink:0}}>
