...
const BUZZ_CACHE = "sh_sports_buzz_v5";
    ...
    return (
      <span key={`${suffix}-${i}`}
        ...
        style={{
          ...
          cursor:h.url?"pointer":"default", flexShrink:0, marginRight:14,
        }}>
        <span style={{
          background:p.badge, color:"#fff", fontSize:9, fontWeight:900,
          letterSpacing:.6, borderRadius:99, padding:"2px 8px",
          flexShrink:0, whiteSpace:"nowrap",
        }}>{p.label}</span>
        <span style={{fontSize:13, fontWeight:600, color:"rgba(240,240,250,.95)", whiteSpace:"nowrap"}}>
          {h.emoji} {h.text}
        </span>
      </span>
    );
