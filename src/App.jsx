        ...
        <div style={{padding:"0 14px 12px",display:"flex",flexDirection:"column",gap:8}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
            ...
            <div onClick={()=>setShowMoodSearch(true)}
              ...
              <span style={{background:"rgba(251,146,60,.2)",border:"1px solid rgba(251,146,60,.4)",borderRadius:99,padding:"2px 8px",fontSize:9,fontWeight:700,color:"#fb923c",alignSelf:"flex-start"}}>Free ✓</span>
            </div>
            ...
            <button onClick={()=>{setView("sports");setSearch("");setShowAllGames(false);window.scrollTo({top:0,behavior:"smooth"});}}
              ...
              <span style={{background:"rgba(239,68,68,.15)",border:"1px solid rgba(239,68,68,.35)",borderRadius:99,padding:"2px 8px",fontSize:9,fontWeight:800,color:"#ef4444",letterSpacing:.5,alignSelf:"flex-start"}}>LIVE</span>
            </button>
              ...
              <div onClick={()=>setShowMoodSearch(true)}
                ...
                <div style={{display:"flex",alignItems:"center",gap:12,position:"relative"}}>
                  ...
                  <div>
                    ...
                    <div style={{fontSize:12,color:"rgba(253,186,116,.8)",fontWeight:500,marginTop:2}}>Describe a vibe — AI finds the perfect match</div>
                  </div>
                </div>
