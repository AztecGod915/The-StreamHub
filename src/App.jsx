          ...
          <div style={{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"}}>
            <div>
              <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:6}}>
                <div style={{background:"#ef4444",borderRadius:99,padding:"2px 8px",fontSize:9,fontWeight:900,color:"#fff",letterSpacing:.8,animation:"pulse 1.5s infinite"}}>🔴 LIVE SCORES</div>
                <div style={{background:"rgba(245,158,11,.2)",borderRadius:99,padding:"2px 8px",fontSize:9,fontWeight:900,color:"var(--gold)",letterSpacing:.8}}>ALL TEAMS</div>
              </div>
