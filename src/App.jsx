...
function PredictionStatsBar() {
  ...
  if (s.total === 0) return (
    <div style={{
      ...
      <div>
        <div style={{fontFamily:"var(--font-head)",fontWeight:800,fontSize:13,color:"#C4B5FD",marginBottom:3}}>Predictions</div>
        <div style={{fontSize:10,color:"rgba(196,181,253,.6)",lineHeight:1.4}}>Tap any game to pick the winner. Build a streak &amp; earn badges.</div>
      </div>
      <button onClick={sharePredictions} style={{marginTop:"auto",background:"rgba(139,92,246,.2)",border:"1px solid rgba(139,92,246,.4)",borderRadius:8,color:"#C4B5FD",padding:"5px 0",fontSize:10,fontWeight:700,cursor:"pointer",width:"100%"}}>📤 Share</button>
    </div>
  );
  ...
  return (
    <div style={{
      ...
      border:"1.5px solid rgba(139,92,246,.35)",
      borderRadius:16, padding:"14px 14px",
      display:"flex", flexDirection:"column", gap:0, minHeight:120,
    }}>
      {/* Title row */}
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:10}}>
        <div style={{fontFamily:"var(--font-head)",fontWeight:800,fontSize:13,color:"#C4B5FD",display:"flex",alignItems:"center",gap:5}}>
          🔮 Predictions {milestone&&<span style={{fontSize:14}}>{milestone.icon}</span>}
        </div>
        <button onClick={sharePredictions} style={{background:"rgba(139,92,246,.2)",border:"1px solid rgba(139,92,246,.4)",borderRadius:7,color:"#C4B5FD",padding:"2px 7px",fontSize:9,fontWeight:700,cursor:"pointer"}}>📤</button>
      </div>
      {/* 2x2 stats grid */}
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:6,marginBottom:10}}>
        {[
          ...
          <div key={st.label} style={{background:"rgba(255,255,255,.05)",borderRadius:9,padding:"6px 4px",textAlign:"center"}}>
            <div style={{fontFamily:"var(--font-head)",fontWeight:900,fontSize:14,color:st.color,lineHeight:1}}>{st.val}</div>
            <div style={{fontSize:8,color:"var(--muted)",fontWeight:700,letterSpacing:.4,marginTop:2}}>{st.label}</div>
          </div>
        ))}
      </div>
      {/* Progress bar */}
...
function FavoriteTeamsBanner({ favoriteTeams }) {
  ...
  if (allFavTeams.length === 0) return (
    <div style={{
      ...
      <div style={{fontSize:28,lineHeight:1}}>⭐</div>
      <div>
        <div style={{fontFamily:"var(--font-head)",fontWeight:800,fontSize:13,color:"var(--gold)",marginBottom:3}}>My Teams</div>
        <div style={{fontSize:10,color:"rgba(245,158,11,.6)",lineHeight:1.4}}>Follow your teams to see their next game instantly here.</div>
      </div>
      <div style={{marginTop:"auto",background:"rgba(245,158,11,.12)",border:"1px solid rgba(245,158,11,.25)",borderRadius:8,padding:"5px 8px",fontSize:9,color:"var(--gold)",fontWeight:700,textAlign:"center"}}>
        Tap ⭐ on any sport to follow
      </div>
    </div>
  );
  ...
  return (
    <div style={{
      ...
      {/* Title */}
      <div style={{fontFamily:"var(--font-head)",fontWeight:800,fontSize:13,color:"var(--gold)",marginBottom:8}}>⭐ My Teams</div>
      {/* Team pills */}
