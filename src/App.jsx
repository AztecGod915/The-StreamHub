...
const BUZZ_FALLBACK = [
  ...
  // Betting odds items
  {text:"ODDS: World Cup Final — Brazil -130 · Argentina +110 · France +140",type:"odds",emoji:"📊",url:"https://www.draftkings.com/sb/sports/soccer"},
  {text:"ODDS: NBA MVP Race — SGA -200 · Wembanyama +180 · Tatum +400",type:"odds",emoji:"📊",url:"https://www.draftkings.com/sb/sports/basketball/nba"},
  {text:"ODDS: UFC — Heavyweight title fight — Aspinall -165 · Jones +140",type:"odds",emoji:"📊",url:"https://www.draftkings.com/sb/sports/mma"},
  {text:"ODDS: MLB World Series — Dodgers +320 · Yankees +450 · Braves +600",type:"odds",emoji:"📊",url:"https://www.draftkings.com/sb/sports/baseball/mlb"},
  {text:"ODDS: EPL Golden Boot — Haaland -150 · Salah +200 · Palmer +350",type:"odds",emoji:"📊",url:"https://www.draftkings.com/sb/sports/soccer/epl"},
  {text:"ODDS: World Cup Top Scorer — Mbappé +250 · Vinicius +300 · Ronaldo +500",type:"odds",emoji:"📊",url:"https://www.draftkings.com/sb/sports/soccer"},
  {text:"ODDS: NFL MVP 2026 season — Lamar Jackson -180 · C.J. Stroud +300",type:"odds",emoji:"📊",url:"https://www.draftkings.com/sb/sports/football/nfl"},
  {text:"ODDS: WNBA Finals — New York Liberty -140 · Las Vegas Aces +120",type:"odds",emoji:"📊",url:"https://www.draftkings.com/sb/sports/basketball/wnba"},
];
...
const BUZZ_CACHE = "sh_sports_buzz_v6";
...
function SportsNewsTicker() {
    ...
    return (
      <span key={`${suffix}-${i}`}
        ...
        style={{
          ...
          borderRadius:99, padding:"2px 10px 2px 3px",
          cursor:h.url?"pointer":"default", flexShrink:0, marginRight:10,
        }}>
        <span style={{
          background:p.badge, color:"#fff", fontSize:8, fontWeight:900,
          letterSpacing:.5, borderRadius:99, padding:"1px 6px",
          flexShrink:0, whiteSpace:"nowrap",
        }}>{p.label}</span>
        <span style={{fontSize:11, fontWeight:600, color:"rgba(240,240,250,.95)", whiteSpace:"nowrap"}}>
          {h.emoji} {h.text}
        </span>
      </span>
    );
  ...
  const duration = Math.max(50, items.length * 5);
  ...
  return (
    <div style={{
      ...
      <div onClick={()=>setPaused(p=>!p)} style={{
        ...
        <span style={{fontSize:11,fontWeight:900,letterSpacing:.8,lineHeight:1.2,textShadow:"0 0 12px rgba(239,68,68,.9)"}}>⚡ SPORTS</span>
        <span style={{fontSize:11,fontWeight:900,letterSpacing:.8,lineHeight:1.2,textShadow:"0 0 12px rgba(239,68,68,.9)"}}>BUZZ</span>
        <span style={{fontSize:15,lineHeight:1,marginTop:2,textShadow:"0 0 10px rgba(239,68,68,1)"}}>{paused?"▶":"⏸"}</span>
      </div>
